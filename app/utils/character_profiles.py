...
CHARACTER_PROFILES = {
    "フォーカス・バリスタ": {
        ...
        "greeting": "さあ、集中モードに切り替えよう。君ならできる"
    },
    "サーモ・コンダクター": {
        "emoji": "🌡️",
        "role": "温度の調律師",
    ...
    "アロマ・キッチェリアン": {
        ...
        "greeting": "深呼吸して...香りに身を委ねて...大丈夫、私がいるから"
    },
    "サウンド・クッカー": {
        "emoji": "🎵",
        "role": "音の料理家",
    ...
    "ノスタル・キッチン": {
        ...
        "greeting": "昔を思い出して...ほっこりしようね...ゆっくりでいいのよ"
    },
    "キャトラリー・バトラー": {
        "emoji": "🎩",
        "role": "猫専属執事",
        ...
        "greeting": "お疲れのご様子ですね。お任せください、お世話させていただきます"
    },
    "スリーピー・シェフ": {
        "emoji": "💤",
        "role": "昼寝導入員",
        ...
        "greeting": "ふぁぁ...疲れたね...一緒にゆっくり...休もう...zzz"
    },
}
